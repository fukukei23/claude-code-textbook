...
```
💡 ユーザー名は公開されます。 реальное имя（本当の名前）ではなく、覚えやすいIDを考えよう。
例: fukukei23、code-beginner-2024 など
```
