...
CHAPTER_MAP = {
    "00_AIの基礎.md": {"slug": "00-ai-basics", "title": "AIの基礎", "icon": "🤖", "desc": "LLMの仕組み・ハルシネーション・コンテキストの基本"},
    "01_環境構築.md": {"slug": "01-setup", "title": "環境構築", "icon": "🏗️", "desc": "WSL2 + Claude Code CLI のセットアップ手順"},
    "02_Claude-Code使い方.md": {"slug": "02-usage", "title": "Claude Codeの使い方", "icon": "⚡", "desc": "基本コマンド・セッション・スキル・MCPの基礎"},
    "03_プロンプト工学.md": {"slug": "03-prompting", "title": "プロンプト工学", "icon": "💬", "desc": "良い指示の書き方・具体例・思考の連鎖"},
